...
in [.gitolite.rc](../rc.md). (That's the preferred way for gitolite starting
with version v3.4.)
...
There are two files where `ukm` must be configured.
  ...
  * [.gitolite.rc](../rc.md) (managed by a [sysadmin](#SYSADMIN) of the gitserver)
...
[guest key managers](#GKM) in [.gitolite.rc](../rc.md) by adding something
like
...
[self key managers](#EKM) in [.gitolite.rc](../rc.md) by adding
