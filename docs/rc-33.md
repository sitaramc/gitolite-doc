...
**NOTE 1**: if you're using v3.4 and above, see [this](rc.md).
...
[migration](migr.md) page and linked pages, and especially the one on "presetting
the rc file"
...
around; start with ["non-core" gitolite](non-core.md).  If a setting is used by a
