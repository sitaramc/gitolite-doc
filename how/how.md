...
<span class="blue">**Navigation**</span>
...
<span class="blue">**To search**</span> for stuff in the full document using your browser's
...
<table ><tr ><td width=50% bgcolor=FFF0F0>
...
*   is done by the ssh server (or perhaps by the http server if you are
    running gitolite in http mode)

</td><td bgcolor=#F0F0FF>
...
<span class="blue">**Terminology reminder**: "ref" in git parlance means "branch or tag".
At least in this page that's what we mean :-)</span>
...
<span class="red">If it doesn't find it, it tells the client and the client asks the user
